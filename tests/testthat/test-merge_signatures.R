...
test_that("Output sizes are correct", {
    expect_equal(dim(output), c(96, 37))
    expect_equal(dim(output_strict), c(96, 45))
    expect_equal(dim(output_char), c(96, 37))
})
...
test_that("Signature names are correct", {
    expect_equal(colnames(output), c("SBS1", "SBS2", "SBS7a", "SBS7b", "SBS7c", "SBS7d", "SBS9", 
                                     ...
                                     "SBS42", "SBS44", "SBS36;SBS18", "SBS15;SBS6", "SBS29;SBS24", 
    ...
    expect_equal(colnames(output_char), c("SBS1", "SBS2", "SBS7a", "SBS7b", "SBS7c", "SBS7d", "SBS9", 
                                          ...
                                          "SBS17b", "SBS20", "SBS21", "SBS22", "SBS25", "SBS28", "SBS30", 
                                          "SBS32", "SBS33", "SBS34", "SBS35", "SBS38", "SBS39", "SBS41", 
                                          "SBS42", "SBS44", "SBS36_SBS18", "SBS15_SBS6", "SBS29_SBS24", 
...
test_that("An error is given when signature names contain merge_char",{
    expect_error({merge_signatures(signatures_colnames)},
