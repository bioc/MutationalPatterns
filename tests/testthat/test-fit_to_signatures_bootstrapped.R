...
test_that("Output has correct class",{
    ...
    output_ori = fit_to_signatures_bootstrapped(mut_mat, signatures, n_boots = 2, max_delta = 0.05, method = "original")
    expect_true(inherits(output_ori, "matrix"))
    
    output_ori_10 = fit_to_signatures_bootstrapped(mut_mat, signatures, n_boots = 2, max_delta = 0.05, method = "original_10+")
