...
<<pdf_device_prep2, echo=FALSE, results=hide>>=
    grDevices::pdf(NULL)
@
...
<<pdf_device_prep3, echo=FALSE, results=hide>>=
    grDevices::dev.off()
@
...
<<pdf_device_prep0, echo=FALSE, results=hide>>=
    grDevices::pdf(NULL)
@
...
<<pdf_device_prep1, echo=FALSE, results=hide>>=
    grDevices::dev.off()
@
